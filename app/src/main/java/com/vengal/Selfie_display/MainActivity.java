...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestImagesTask request = new RequestImagesTask("https://api.instagram.com/v1/tags/selfie/media/recent?access_token=1306936804.2ddaf40.fdbb4ae129fd4e4d8434a2ccd0deffe1", this);
		request.execute();
